          ...
          <main className="px-3 max-w-6xl mx-auto">
            <section className="py-20 lg:py-32">
              <div>
                ...
                <h3 className="text-3xl my-6">Allgemeine Hinweise</h3>{" "}
                <p>
                ...
                <h4 className="text-2xl my-6">Wie erfassen wir Ihre Daten?</h4>{" "}
                <p>
                ...
                <h2 className="text-4xl my-6">2. Hosting</h2>
                <p>
                  Wir hosten die Inhalte unserer Website bei folgendem Anbieter:
                </p>
                <h3 className="text-3xl my-6">Aktuell Anbieterwechsel</h3>{" "}
                <p>
                  Durch den zurzeitigen Wechsel des Anbieters, können wir keine
                  genaue Angabe zu dem Website Anbieter angeben.
                  {/* Anbieter ist die ALL-INKL.COM - Neue Medien M&uuml;nnich, Inh.
                  Ren&eacute; M&uuml;nnich, Hauptstra&szlig;e 68, 02742
                ...
                <p>
                  ...
                  oder den Zugriff auf Informationen im Endger&auml;t des
                ...
                <h3 className="text-3xl my-6">Datenschutz</h3>{" "}
                <p>
                ...
                <h3 className="text-3xl my-6">Speicherdauer</h3>{" "}
                <p>
                ...
                <h3 className="text-3xl my-6">Cookies</h3>{" "}
                <p>
                  ...
                  diese selbst l&ouml;schen oder eine automatische L&ouml;schung
                ...
                <p>
                  ...
                  technisch notwendig, da bestimmte Webseitenfunktionen ohne
                  diese nicht funktionieren w&uuml;rden (z.&nbsp;B. die
                ...
                <p>
                  ...
                  Ihnen erw&uuml;nschter Funktionen (z.&nbsp;B. f&uuml;r die
                ...
                <h3 className="text-3xl my-6">Server-Log-Dateien</h3>{" "}
                <p>
                ...
                <h3 className="text-4xl my-6">Kontaktformular</h3>{" "}
                <p>
                ...
                <h2 className="text-4xl my-6">5. Analyse-Tools und Werbung</h2>
                <h3 className="text-3xl my-6">Nutzung von Google Analytics</h3>
                <p>
                ...
                <p>
                  ...
                  Sicherheit und Vertraulichkeit der verarbeiteten Daten zu
                  gewährleisten.
                </p>
                <p>
                ...
                <p>
                  Aufgerufene Seiten Bestellungen inkl. des Umsatzes und der
                  bestellten Produkte Die Erreichung von "Website-Zielen" (z.B.
                  Kontaktanfragen und Newsletter-Anmeldungen) Ihr Verhalten auf
                  den Seiten (beispielsweise Verweildauer, Klicks,
                  Scrollverhalten) Ihr ungefährer Standort (Land und Stadt) Ihre
                  IP-Adresse (in gekürzter Form, sodass keine eindeutige
                  Zuordnung möglich ist) Technische Informationen wie Browser,
                  Internetanbieter, Endgerät und Bildschirmauflösung
                  Herkunftsquelle Ihres Besuchs (d.h. über welche Website bzw.
                  über welches Werbemittel Sie zu uns gekommen sind) Es werden
                  niemals persönliche Daten wie Name, Anschrift oder
                  Kontaktdaten an Google Analytics übertragen.
                </p>
                <p>
                  Diese Daten werden an Server von Google in den USA übertragen.
                  Wir weisen darauf hin, dass in den USA datenschutzrechtlich
                  nicht das gleiche Schutzniveau wie innerhalb der EU garantiert
                  werden kann.
                </p>
                <p>
                ...
                <p>
                  Sollten Sie mit der Erfassung nicht einverstanden sein, können
                  Sie diese mit der einmaligen Installation des Browser-Add-ons
                  zur Deaktivierung von Google Analytics unterbinden oder durch
                  das Ablehnen der Cookies über unseren
                  Cookie-Einstellungs-Dialog.
                </p>
                <h2 className="text-4xl my-6">6. Plugins und Tools</h2>
                <h3 className="text-3xl my-6">Google Fonts</h3>{" "}
                <p>
                  ...
                  Browser die ben&ouml;tigten Fonts in ihren Browsercache, um
                ...
                <p>
                  ...
                  Google Fonts erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f
                ...
                <p>
                  Wenn Ihr Browser Google Fonts nicht unterst&uuml;tzt, wird
                ...
                <h3 className="text-3xl my-6">Google Maps</h3>{" "}
                <p>
                  Diese Seite nutzt den Kartendienst Google Maps. Anbieter ist
                  die Google Ireland Limited (&bdquo;Google&ldquo;), Gordon
                ...
                <p>
                  ...
                  einheitlichen Darstellung der Schriftarten Google Fonts
                  verwenden. Beim Aufruf von Google Maps l&auml;dt Ihr Browser
                  die ben&ouml;tigten Web Fonts in ihren Browsercache, um Texte
                ...
                <p>
                  ...
                  Verarbeitung ausschlie&szlig;lich auf Grundlage von Art. 6
