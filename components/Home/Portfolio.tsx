    ...
    <div className="my-24 px-3 max-w-6xl mx-auto">
      ...
      <div className="text-black pt-8 flex gap-12 flex-col">
        ...
        <div className="flex gap-12 flex-col md:flex-row">
          ...
          <div className=" bg-[#FFEE62] px-4 pt-4 rounded-2xl relative w-full group hover:scale-[100.5%] hover:shadow-lg hover:shadow-white/5 duration-300">
          ...
          <div className=" bg-[#6EE863] px-4 pt-4 rounded-2xl w-full group hover:scale-[100.5%] hover:shadow-lg hover:shadow-white/5 duration-300">
        ...
        <div className="flex gap-12 flex-col md:flex-row">
          ...
          <div className=" bg-[#9747FF] px-4 pt-4 rounded-2xl w-full group hover:scale-[100.5%] hover:shadow-lg hover:shadow-white/5 duration-300">
            {/* bg-[#9747FF] */}
          ...
          <div className=" bg-[#FF8540] px-4 pt-4 rounded-2xl w-full group hover:scale-[100.5%] hover:shadow-lg hover:shadow-white/5 duration-300">
        ...
        <div className="flex gap-12 flex-col md:flex-row">
          ...
          > */}
          <div className=" bg-[#62B2FB] px-4 pt-4 rounded-2xl relative block w-full group hover:scale-[100.5%] hover:shadow-lg hover:shadow-white/5 duration-300">
          ...
          <div className=" bg-[#FB4B4B] px-4 pt-4 rounded-2xl w-full group hover:scale-[100.5%] hover:shadow-lg hover:shadow-white/5 duration-300">
